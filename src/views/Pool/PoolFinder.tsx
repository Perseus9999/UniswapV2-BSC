...
import { Button, ChevronDownIcon, Text, NextLinkFromReactRouter, Flex, Box, Card, CardBody, OpenNewIcon, AddIcon } from 'components'
  ...
  return (
    <Page>
      <Flex justifyContent="center" mt="40px">
        <AppBody>
          <AppHeader title='Import Pool' backTo="/liquidity" />
